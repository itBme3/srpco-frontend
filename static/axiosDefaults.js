...
const populate = ['media', 'seo.image', 'file',
      ...
      ...[...collectionTypes, "pages"].map(collectionType => `${collectionType}.${collectionType === 'datasheets' ? 'file' : 'media' }`),
      ...[...collectionTypes, "pages"].map(collectionType => `blocks.${collectionType}`),
      ...[...collectionTypes, "pages"].map(collectionType => `solutions.used.${collectionType}`),
      ...[...collectionTypes, "pages"].map(collectionType => `blocks.${collectionType}.${collectionType === 'datasheets' ? 'file' : 'media' }`),
      ...[...collectionTypes, "pages"].map(collectionType => `blocks.sections.${collectionType}`),
      ...[...collectionTypes, "pages"].map(collectionType => `blocks.sections.${collectionType}.${collectionType === 'datasheets' ? 'file' : 'media' }`),
]
